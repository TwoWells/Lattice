...
///
/// Returns the byte length of the opening line (including the line ending)
/// or `None` if no frontmatter opener is found. Recognizes `\n`, `\r\n`, and
/// bare `\r` (legacy-Mac) line endings; the `\r\n` form is checked first so
/// its trailing `\n` is not mistaken for the start of the content.
